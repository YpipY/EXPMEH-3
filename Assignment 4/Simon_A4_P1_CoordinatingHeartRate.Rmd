...
setwd("C:/Users/slmoni/Documents/Uni/Experimental Methods III/EXPMEH3/Assignment 4/data/CleanData/")
...
```{r, include=FALSE}
# Loading data
data<- read.csv('Study1_G1_T1_Synchronous.csv')
plot(data$time,data$Resp1)
```
