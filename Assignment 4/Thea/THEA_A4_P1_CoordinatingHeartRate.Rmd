...
for (d in files) {
  p = prep(d)
  write.csv(p, file = paste(prep_path,"prep_",d))
...
```{r}
setwd("~/EXPMETH3/Assignment 4/Thea/prep")
...
setwd("~/Documents/3. SEMESTER/Experimental Methods 3/Portfolios/Portfolio 7/prep/")
#TIME TO LOOOOOOOP
...
recur <- function(filename) {
  ...
  Results=crqa(d$down.HR1, d$down.HR2, delay=ans[[3]], embed=ans[[2]], radius=ans[[1]], normalize=0, rescale=0, mindiagline = 2, minvertline = 2)
...
recur("prep_Study1_G2_T1_TurnTaking")

g <- read.csv("prep_Study1_G2_T1_TurnTaking.csv")
