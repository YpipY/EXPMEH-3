...
#spline tests
ex = read.csv("Assignment 4/data/CleanData/Study2_G7_T3_TurnTaking.csv")
...
clean_file = function(filename) {
  ...
  if(isBig==9){
    crap<-dplyr::select(currentData,"ReadingStart","ReadingStop") 
    currentData$ReadingStart <- NULL
    currentData$ReadingStop <- NULL
  }
  
  # Replacing outliers with a spline
  tryCatch({currentData = na.spline(currentData,maxgap=5000)
