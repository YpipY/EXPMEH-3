...
for (i in seq_along(combination[[1]])) {
  ...
  Res_HR = try(expr=(crqa(one_HR$hr1, two_HR$hr2, delay = 22, embed = 11, radius = 1.652331, normalize=0, rescale=0, mindiagline = 2, minvertline = 2)))
  Res_Resp = try(expr=(crqa(one_Resp$resp1, two_Resp$resp2, delay = 22, embed = 11, radius = 1.652331, normalize=0, rescale=0, mindiagline = 2, minvertline = 2)))
  ...
  surrogate_Synchronous = rbind(surrogate_Synchronous, c(p1, p2, "Synchronous", RR_HR, DET_HR, maxL_HR, L_HR, TT_HR, RR_Resp, DET_Resp, maxL_Resp, L_Resp, TT_Resp))
...
#rename recur_data
recur_data$Condition = ifelse(recur_data$Condition == "Synchr", "Synchronous", recur_data$Condition)
recur_data$Condition = ifelse(recur_data$Condition == "_Synch", "Synchronous", recur_data$Condition)
recur_data$Condition = ifelse(recur_data$Condition == "TurnTa", "TurnTaking", recur_data$Condition)
recur_data$Condition = ifelse(recur_data$Condition == "_TurnT", "TurnTaking", recur_data$Condition)
recur_data$Condition = ifelse(recur_data$Condition == "Conver", "Conversation", recur_data$Condition)
recur_data$Condition = ifelse(recur_data$Condition == "_Conve", "Conversation", recur_data$Condition)

#rename shuffeld
recur_data_shuffle$Condition = ifelse(recur_data_shuffle$Condition == "Synchr", "Synchronous", recur_data_shuffle$Condition)
recur_data_shuffle$Condition = ifelse(recur_data_shuffle$Condition == "_Synch", "Synchronous", recur_data_shuffle$Condition)
recur_data_shuffle$Condition = ifelse(recur_data_shuffle$Condition == "TurnTa", "TurnTaking", recur_data_shuffle$Condition)
recur_data_shuffle$Condition = ifelse(recur_data_shuffle$Condition == "_TurnT", "TurnTaking", recur_data_shuffle$Condition)
recur_data_shuffle$Condition = ifelse(recur_data_shuffle$Condition == "Conver", "Conversation", recur_data_shuffle$Condition)
recur_data_shuffle$Condition = ifelse(recur_data_shuffle$Condition == "_Conve", "Conversation", recur_data_shuffle$Condition)
...
int_RR_RE_model = lm(RR_HR ~ Condition * baseline , all_recur_data)
...
int_DET_RE_model = lm(DET_HR ~ Condition * baseline , all_recur_data)
...
int_maxL_RE_model = lm(maxL_HR ~ Condition * baseline , all_recur_data)
...
int_L_RE_model = lm(L_HR ~ Condition * baseline , all_recur_data)
...
int_TT_RE_model = lm(TT_HR ~ Condition * baseline , all_recur_data)
...
plot_model(int_RR_HR_model, type = "pred", terms = c("RR_HR", "Condition"))
plot_model(int_RR_RE_model, type = "pred", terms = c("RR_RE", "Condition"))
 
plot_model(int_RR_HR_model, type = "int")
 


effect_plot(int_RR_HR_model, pred = RR_HR)

cat_plot(int_RR_RE_model, pred = baseline, modx = Condition, geom = "line", plot.points = TRUE)
